...
public class StringHashSet implements Set<String> {
    ...
    public boolean contains(Object o) {
        return this.getBucked(o).contains(o);
    }
    ...
    public boolean add(String potencialMember) {
        ...
        List<String> bucket = this.getBucked(potencialMember);
    ...
    public boolean remove(Object o) {
        ...
        boolean result = this.getBucked(o).remove(o);
    ...
    public String toString() {
        return "{" + this.buckets.stream().flatMap(bucket -> bucket.stream()).collect(Collectors.joining(", ")) + "}";
    }

    private List<String> getBucked(Object o) {
        int hash = o.hashCode();
